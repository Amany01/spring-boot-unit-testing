...
public class ReflectionTestUtilsTest {
    ...
    public void studentBeforeEach () {
        studentOne.setFirstname("Amany");
        studentOne.setLastname("Fawzy");
        studentOne.setEmailAddress("amany@fawzy.com");
        studentOne.setStudentGrades(studentGrades);
        //setting private field directly without using setter methods
    ...
    public void invokePrivateMethod () {
        assertEquals("Amany 1",
                ReflectionTestUtils.invokeMethod(studentOne, "firstNameAndId"),
