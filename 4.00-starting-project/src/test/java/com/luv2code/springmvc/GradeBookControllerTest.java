...
public class GradeBookControllerTest {
    ...
    public static void setup () {
        ...
        request.setParameter("email", "amany@fawzy.com");
    }
    ...
    public void getStudentsHttpRequest () throws Exception {
        ...
        student.setEmailAddress("chad@darby.com");
    ...
    public void createStudentHttpRequest () throws Exception {
        ...
        CollegeStudent verifyStudent = studentDao.findByEmailAddress("chad@darby.com");
    ...
    @Test
    public void createANoneValidGradeHttpRequestGradeTypeDoesNotExistEmptyResponse () throws Exception {
        this.mockMvc.perform(post("/grades")
                .contentType(MediaType.APPLICATION_JSON)
                .param("grade","85.00")
                .param("gradeType", "art")
    ...
    public void deleteANonValidGradeHttpRequest () throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.delete("/grades/{id}/{gradeType}", 2, "art"))
                .andExpect(status().is4xxClientError())
                .andExpect(jsonPath("$.status", is(404)))
                .andExpect(jsonPath("$.message", is("Student or Grade was not found")));
    }
